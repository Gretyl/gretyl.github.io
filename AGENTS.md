...
- **Social preview cards:** Standalone HTML pages embed OpenGraph `<meta>` tags in `<head>` for link previews on Mastodon, Discord, etc. Preview images live in `docs/assets/`. Use `docs/tools/opengraph-preview.html` to test cards before pushing
